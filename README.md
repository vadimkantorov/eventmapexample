...
- [`_site/events.html`](_site/events.html) contains all HTML for main page and for campaign pages
- [`_site/style.css`](_site/style.css) specifies all styles and can be modified for style customization
- [`_site/script.js`](_site/script.js) contains all JavaScript
- [`_site/leaflet@1.8.0/dist/leaflet.css`](_site/leaflet@1.8.0/dist/leaflet.css), [`_site/leaflet@1.8.0/dist/leaflet.js`](_site/leaflet@1.8.0/dist/leaflet.js) are the [LeafletJS](https://leafletjs.com/) script and style files
